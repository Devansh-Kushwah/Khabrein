package com.example.khabrein.ui.slideshow
...
class SlideshowFragment : Fragment(),NewsitemClicked {
    ...
    private fun fetcdata(){
        val url = "https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=120fead7bbb04a779388c1e623943c85"
